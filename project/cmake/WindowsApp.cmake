...
add_library(DlssnrForwarder SHARED src/effects/real/dlssnr_forwarder.cpp)
set_target_properties(DlssnrForwarder PROPERTIES PREFIX "" OUTPUT_NAME "nvngx.dll_dlssnr")
target_include_directories(DlssnrForwarder PRIVATE "${NGX_INCLUDE_DIR}")
target_link_libraries(DlssnrForwarder PRIVATE dscreen_flags)

add_executable(FullScreenWrapperForDLSS5 ${DSCREEN_REAL_SOURCES})
add_dependencies(FullScreenWrapperForDLSS5 FullScreenWrapperForDLSS5Shaders DlssnrForwarder)
...
endforeach()
install(TARGETS FullScreenWrapperForDLSS5 DlssnrForwarder RUNTIME DESTINATION .)
